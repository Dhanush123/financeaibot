...
function getSingleStock (body, gRes) {
  ...
  request(options, function (error, response, body) {
    ...
    console.log("1st single stock call",body.resultMap.SEARCH_RESULTS);
    var peRatio = body.resultMap.SEARCH_RESULTS[1].resultList[0].peRatio;
    var previousClosePrice = body.resultMap.SEARCH_RESULTS[1].resultList[0].previousClosePrice;
